...
class login3(unittest.TestCase):
    ...
    def test_login3(self):
        ...
        ActionChains(wd).move_to_element(wd.find_element_by_id("loginform")).perform()
        ActionChains(wd).move_to_element(wd.find_element_by_css_selector("div.col-xs-8")).perform()
     ...
     #   wd.find_element_by_id("password").send_keys("\\undefined")
        ...
        ActionChains(wd).move_to_element(wd.find_element_by_xpath("//div[@id='movie_5']/div[1]/div")).perform()
        ActionChains(wd).move_to_element(wd.find_element_by_id("movie_5")).perform()
        ActionChains(wd).move_to_element(wd.find_element_by_css_selector("section.content")).perform()
